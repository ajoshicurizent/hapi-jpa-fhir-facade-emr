...
public class AppProperties {
	...
	private PreloadResources preload_resources = new PreloadResources();
	...
	public PreloadResources getPreload_resources() {
		return preload_resources;
	}

	public void setPreload_resources(PreloadResources preload_resources) {
		this.preload_resources = preload_resources;
	}
	...
	/**
	 * Load FHIR conformance resources (StructureDefinition, ValueSet, CodeSystem, etc.)
	 * from the classpath into the JPA repository at application startup.
	 */
	public static class PreloadResources {

		private Boolean enabled = false;
		/**
		 * Spring resource pattern resolved relative to the classpath (and optionally
		 * the filesystem). Default scans every JSON file under {@code fhir/}.
		 */
		private String path = "classpath*:fhir/**/*.json";
